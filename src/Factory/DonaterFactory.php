...
/**
 * @extends PersistentProxyObjectFactory<Donater>
 */
final class DonaterFactory extends PersistentProxyObjectFactory{
    /**
    ...
    #[\Override]    protected function defaults(): array|callable    {
        return [
            ...
            'registrationDate' => self::faker()->dateTime(),
        ];
    }
    ...
    {
        return $this
            // ->afterInstantiate(function(Donater $donater): void {})
        ;
    }
}
