...
#[Route('/benevoles/tous', name: 'app_benevole_all')]
public function allBenevoles(BenevoleRepository $repo): Response
{
    $allBenevoles = $repo->findAll();

    return $this->render('benevole/all_benevoles.html.twig', [
        'allBenevoles' => $allBenevoles,
    ]);
}
